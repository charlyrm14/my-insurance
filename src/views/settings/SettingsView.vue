...
<template>
    <div class="mt-4 space-y-4">
        ...
        <p class="flex items-center uppercase gap-2"> 
        ...
        <section class="mt-10">
            ...
            <div class="mt-5 border-b-1 border-gray-300 dark:border-slate-700 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-400 p-2">
                <div class="flex min-w-0 gap-x-4 items-center mb-3">
                    ...
                    <div class="min-w-0 flex-auto">
                        <p class="uppercase text-sm dark:text-gray-100"> Notificaciones </p>
                    </div>
                </div>
            </div>

            <div class="mt-2 border-b-1 border-gray-300 dark:border-slate-700 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-400 p-2">
                <div class="flex justify-between">
                    <div class="flex min-w-0 gap-x-4 items-center mb-3">
                        ...
                        <div class="min-w-0 flex-auto">
                            <p class="uppercase text-sm dark:text-gray-100"> Aspecto </p>
                        </div>
                    </div>
                    <div>
                        <button
                            class="p-2 rounded-full transition bg-gray-200 dark:bg-gray-700 text-black dark:text-white">
                                🌙 Modo Oscuro
                        </button>
                    </div>
                </div>
        ...
        <section class="mt-10">
            <p class="dark:text-gray-100"> Cuenta </p>
            <span class="text-sm dark:text-gray-400"> Administra los ajustes de tu cuenta </span>
            ...
            <div class="mt-5 border-b-1 border-gray-300 dark:border-slate-700 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-400 p-2">
                <div class="flex min-w-0 gap-x-4 items-center mb-3">
                    ...
                    <div class="min-w-0 flex-auto">
                        <p class="uppercase text-sm text-red-500"> Cerrar sesión </p>
                    </div>
                </div>
            </div>
        </section>
